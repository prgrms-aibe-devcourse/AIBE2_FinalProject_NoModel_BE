...
import com.example.nomodel.model.command.application.dto.response.AdResultAverageRatingResponseDto;
import com.example.nomodel.model.command.application.dto.response.AdResultCountResponseDto;
import com.example.nomodel.model.command.application.dto.response.AdResultResponseDto;
import com.example.nomodel.model.query.service.AdResultQueryService;
...
public class AdResultController {
    ...
    private final AdResultQueryService adResultQueryService;
    ...
    public ResponseEntity<ApiUtils.ApiResult<Page<AdResultResponseDto>>> getMyAdResults(
        ...
        Page<AdResultResponseDto> results = adResultQueryService.getMemberAdResults(userDetails.getMemberId(), pageable);
    ...
    public ResponseEntity<ApiUtils.ApiResult<AdResultResponseDto>> getMyAdResult(
        ...
        AdResultResponseDto result = adResultQueryService.getMemberAdResult(userDetails.getMemberId(), adResultId);
    ...
    public ResponseEntity<ApiUtils.ApiResult<AdResultCountResponseDto>> getMyProjectCount(
        ...
        AdResultCountResponseDto count = adResultQueryService.getMemberProjectCount(userDetails.getMemberId());
    ...
    public ResponseEntity<ApiUtils.ApiResult<AdResultAverageRatingResponseDto>> getMyAverageRating(
        ...
        AdResultAverageRatingResponseDto rating = adResultQueryService.getMemberAverageRating(userDetails.getMemberId());
    ...
    public ResponseEntity<ApiUtils.ApiResult<String>> updateAdResultRating(
        ...
        adResultCommandService.updateAdResultRating(userDetails.getMemberId(), adResultId, request.memberRating());
